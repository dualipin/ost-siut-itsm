...
class PermissionMiddleware extends BaseMiddleware
{
    ...
    public function setRequiredPermissions(
        array $permissions,
        ...
        if ($this->requireAll) {
            foreach ($this->requiredPermissions as $permission) {
                if (!$this->authService->hasPermission($permission)) {
                    return $this->deny(
                        "No tiene los permisos necesarios. Permiso requerido: " .
                            $permission,
                    );
                }
            }
            ...
            if (!$hasPermission) {
                return $this->deny(
                    "No tiene los permisos necesarios. Permisos requeridos: " .
                        implode(", ", $this->requiredPermissions),
                );
            }
        }
