...
$sql = "INSERT INTO documentos_gestoria (titulo, contenido, adjunto, fecha_documento, privado) VALUES (?, ?, ?, ?, ?)";
$params = [
        $titulo,
        $contenido,
        $nombreArchivo,
...
if ($stmt->execute($params)) {
    ...
    if ($nombreArchivo) {
        $rutaArchivo = __DIR__ . '/../../privado/archivos/repositorios/' . $nombreArchivo;
