        ...
        <form className="row g-3 align-items-end" onSubmit={(e) => {
          ...
          <div className="col-12 col-lg-4">
            ...
            <input
              ...
              value={search}
              onChange={(e) => useFilters.setState({ search: e.target.value })}
          ...
          <div className="col-12 col-lg-2">
            ...
            <select
              ...
              onChange={(e) =>
                useFilters.setState({
                  status:
                    e.target.value === "" ? undefined : (e.target.value as LoanStatus),
                })
              }
            >
          ...
          <div className="col-12 col-lg-2">
            ...
            <input
              ...
              className="form-control rounded-3"
              value={fromDate}
              onChange={(e) => useFilters.setState({ fromDate: e.target.value })}
            />
          </div>
          <div className="col-12 col-lg-2">
            <label className="form-label fw-semibold small text-uppercase text-muted">
            ...
            <input
              ...
              className="form-control rounded-3"
              value={toDate}
              onChange={(e) => useFilters.setState({ toDate: e.target.value })}
            />
          </div>
